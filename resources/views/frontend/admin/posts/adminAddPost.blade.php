                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{route('store-post')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Post Title" name="title" value="{{ old('title')}}" @error('title') is-invalid @enderror>
                       @error('title')
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="content" value="{{old('content')}}" @error('content') is-invalid @enderror></textarea>
                       @error('content')
                        <p class="badge badge-danger text-danger">
                           {{ $message }}
                        </p>
